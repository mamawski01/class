  ...
  return (
    <div className="relative w-48">
      ...
      <Datepicker
        ...
        toggleClassName="absolute  rounded-r text-white right-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed bg-zinc-800"
        onChange={(newValue) => {
          setValue(newValue);
