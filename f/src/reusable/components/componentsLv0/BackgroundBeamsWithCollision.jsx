...
export default function BackgroundBeamsWithCollision({ children }) {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "absolute inset-0 h-screen w-full items-center justify-center overflow-hidden from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800",
      )}
    >
      {beams.map((beam) => (
        <CollisionMechanism
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-56 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-indigo-500 via-purple-500 to-transparent",
